    ...
    extends TestCase
{
    ...
    private static Properties transform( GroovyResourceTransformer transformer, boolean consistentDates )
        throws Exception
    {
        ...
        transformer.modifyOutputStream( jaos, consistentDates );
        jaos.close();
        ...
        throws Exception
    {
        ...
        assertNull( transform( transformer, false ) );
    }
